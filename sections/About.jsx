  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.p
        ...
        className="mt-2 font-normal sm:text-[32px] text-xl text-center text-secondary-white leading-[57px] mb-7"
      >
      ...
      <motion.img variants={fadeIn('up', 'tween', 0.3, 1)} src="/arrow-down.svg" alt="arrow-down" className="w-[18px] h-[28px] object-contain" />
    </motion.div>
  </section>
);
